...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        This is the main function that will perform the data transformtion
        '''
        try:
            ...
            #create a pipline and handle missing values
            num_pipeline= Pipeline(
                steps=[
                ("imputer", SimpleImputer(strategy="median")), #here we are replacing the missing values by median of data
